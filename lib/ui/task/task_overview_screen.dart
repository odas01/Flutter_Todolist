...
class _TaskOverviewScreenState extends State<TaskOverviewScreen> {
  ...
  late Future<void> _fetchTasks;

  @override
  void initState() {
    super.initState();

    _fetchTasks = context.read<TasksManager>().fetchTasks();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Consumer<PlansManager>(builder: (ctx, planManager, child) {
            var itemsDropdown = planManager.items;
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              final items = Provider.of<TasksManager>(context).items;
              return Padding(
